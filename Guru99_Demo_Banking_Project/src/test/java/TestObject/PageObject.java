...
public class PageObject {
	...
	public boolean FundTransferText() {
		return FundTransfer.isSelected();
	}

	@FindBy(xpath = "/html/body/div[3]/div/ul/li[10]")
	WebElement FundTransferForm;

	public void FundTransferForm() {
		String FTF = FundTransferForm.getText();
		System.out.println(FTF);

		if (FTF.equals(FTF)) {
			Assert.assertTrue(true);
			System.out.println("Fund Transfer Form Text is verified");
		} else {
			Assert.assertTrue(true);
			System.out.println("Fund Transfer Form Text is not verified");
		}
	}

	@FindBy(xpath = "/html/body/table/tbody/tr/td/table/tbody/tr[4]/td[2]/input")
	WebElement FundPayersAccountNo;

	public void FundPayersAccountNo() {
		FundPayersAccountNo.click();
		FundPayersAccountNo.sendKeys("113101");
	}

	@FindBy(xpath = "/html/body/table/tbody/tr/td/table/tbody/tr[5]/td[2]/input")
	WebElement FundPayeesAccountNo;

	public void FundPayeesAccountNo() {
		FundPayeesAccountNo.click();
		FundPayeesAccountNo.sendKeys("113101");
	}
	...
	public void FundTransferAmount() {
		FundTransferAmount.click();
		FundTransferAmount.sendKeys("550");
	}

	@FindBy(xpath = "/html/body/table/tbody/tr/td/table/tbody/tr[7]/td[2]/input")
	WebElement FundTransferDescription;

	public void FundTransferDescription() {
		FundTransferDescription.click();
		FundTransferDescription.sendKeys("Fund Transfered ,Please check and verified");
	}

	@FindBy(xpath = "/html/body/table/tbody/tr/td/table/tbody/tr[6]/td[2]/input")
	WebElement FundTransferSubmitBtn;

	public void FundTransferSubmitBtn() {
		FundTransferSubmitBtn.click();
//		driver.switchTo().alert().accept();
	}
	...
	@FindBy(xpath = "/html/body/div[3]/div/ul/li[11]")
	...
	public boolean ChangePasswordText() {
	...
	public void OldPassword() {
		OldPassword.click();
		OldPassword.sendKeys("Rider5699@");
	}
	...
	public void NewPassword() {
		NewPassword.click();
		NewPassword.sendKeys("Rider56999@");
	}
	...
	public void ConfirmPassword() {
		...
		ConfirmPassword.sendKeys("Rider56999@");
	}
	...
	public void ChangePasswordForm() {
		String CPF = ChangePasswordForm.getText();
		System.out.println(CPF);

		if (CPF.equals(CPF)) {
			Assert.assertTrue(true);
			System.out.println("Change Password Form Text is verified");
		} else {
			Assert.assertTrue(true);
			System.out.println("Change Password Form Text is not verified");
		}
	...
	public void ChangePasswordSubmitBtn() {
		ChangePasswordSubmitBtn.click();

		String Alert_Text = driver.switchTo().alert().getText();

		System.out.println(" Alert Box Message = " + Alert_Text);

		driver.switchTo().alert().accept();

	}

	@FindBy(xpath = "/html/body/div[3]/div/ul/li[12]")
	...
	public boolean BalanceEnquiryText() {
		return BalanceEnquiry.isDisplayed();
	}

	@FindBy(xpath = "/html/body/div[3]/div/ul/li[10]")
	WebElement BalanceEnquiryForm;

	public void BalanceEnquiryForm() {
		String BEF = BalanceEnquiryForm.getText();
		System.out.println(BEF);

		if (BEF.equals(BEF)) {
			Assert.assertTrue(true);
			System.out.println("Balance Enquiry Form Text is verified");
		} else {
			Assert.assertTrue(true);
			System.out.println("Balance Enquiry Form Text is not verified");
		}
	}

	@FindBy(xpath = "/html/body/table/tbody/tr/td/table/tbody/tr[6]/td[2]/input")
	WebElement BalanceAccountNo;

	public void BalanceAccountNo() {
		BalanceAccountNo.click();
		BalanceAccountNo.sendKeys("113101");
	}

	@FindBy(xpath = "/html/body/table/tbody/tr/td/table/tbody/tr[11]/td[2]/input[1]")
	WebElement BalanceSubmitBtn;

	public void BalanceSubmitBtn() {
		BalanceSubmitBtn.click();
	}

	@FindBy(xpath = "/html/body/div[3]/div/ul/li[13]")
	...
	public boolean MiniStatementText() {
		return MiniStatement.isDisplayed();
	}

	@FindBy(xpath = "/html/body/table/tbody/tr/td/table/tbody/tr[1]/td/p")
	WebElement MiniStatementForm;

	public void MiniStatementForm() {
		String MSF = MiniStatementForm.getText();
		System.out.println(MSF);

		if (MSF.equals(MSF)) {
			Assert.assertTrue(true);
			System.out.println("Mini Statement Form Text is verified");
		} else {
			Assert.assertTrue(true);
			System.out.println("Mini StatementForm Text is not verified");
		}
	}

	@FindBy(xpath = "/html/body/table/tbody/tr/td/table/tbody/tr[6]/td[2]/input")
	WebElement MiniStatementAccountNo;

	public void MiniStatementAccountNo() {
		MiniStatementAccountNo.click();
		MiniStatementAccountNo.sendKeys("113101");
	}

	@FindBy(xpath = "/html/body/table/tbody/tr/td/table/tbody/tr[11]/td[2]/input[1]")
	WebElement MiniStatementSubmitBtn;

	public void MiniStatementSubmitBtn() {
		MiniStatementSubmitBtn.click();
	}

	@FindBy(xpath = "/html/body/div[3]/div/ul/li[14]")
	...
	public boolean CustomisedStatementText() {
		return CustomisedStatement.isDisplayed();
	}

	@FindBy(xpath = "/html/body/table/tbody/tr/td/table/tbody/tr[1]/td/p")
	WebElement CustomisedStatementForm;

	public void CustomisedStatementForm() {
		String CSF = CustomisedStatementForm.getText();
		System.out.println(CSF);

		if (CSF.equals(CSF)) {
			Assert.assertTrue(true);
			System.out.println("Customised Statement Form Text is verified");
		} else {
			Assert.assertTrue(true);
			System.out.println("Customised Statement Form Text is not verified");
		}
	}

	@FindBy(xpath = "/html/body/table/tbody/tr/td/table/tbody/tr[6]/td[2]/input")
	WebElement CustomisedStatementAccountNo;

	public void CustomisedStatementAccountNo() {
		CustomisedStatementAccountNo.click();
		CustomisedStatementAccountNo.sendKeys("113101");
	}

	@FindBy(xpath = "/html/body/table/tbody/tr/td/table/tbody/tr[7]/td[1]")
	WebElement FromDate;
	...
	public void FromDate() throws InterruptedException {
		...
		act.moveToElement(FromDate).moveByOffset(140, 0).click().sendKeys("10").build().perform();

		act.moveToElement(FromDate).moveByOffset(150, 0).click().sendKeys("01").build().perform();
	...
	public void FromDateYEAR() {
		FromDateYEAR.click();
		FromDateYEAR.sendKeys("2022");
	}

	@FindBy(xpath = "/html/body/table/tbody/tr/td/table/tbody/tr[8]/td[1]")
	WebElement ToDate;
	...
	public void ToDate() throws InterruptedException {
		...
		act.moveToElement(ToDate).moveByOffset(140, 0).click().sendKeys("10").build().perform();

		act.moveToElement(ToDate).moveByOffset(150, 0).click().sendKeys("30").build().perform();
	...
	public void ToDateYEAR() {
		ToDateYEAR.click();
		ToDateYEAR.sendKeys("2022");
	}

	@FindBy(xpath = "/html/body/table/tbody/tr/td/table/tbody/tr[9]/td[2]/input")
	WebElement CustomisedStatementMiniTransValue;

	public void CustomisedStatementMiniTransValue() {
		CustomisedStatementMiniTransValue.click();
		CustomisedStatementMiniTransValue.sendKeys("10");
	}

	@FindBy(xpath = "/html/body/table/tbody/tr/td/table/tbody/tr[10]/td[2]/input")
	WebElement CustomisedStatementNumOfTrans;

	public void CustomisedStatementNumOfTrans() {
		CustomisedStatementNumOfTrans.click();
		CustomisedStatementNumOfTrans.sendKeys("100");
	}

	@FindBy(xpath = "/html/body/table/tbody/tr/td/table/tbody/tr[13]/td[2]/input[1]")
	WebElement CustomisedStatementSubmitBtn;

	public void CustomisedStatementSubmitBtn() {
		CustomisedStatementSubmitBtn.click();
	}
	...
	public void LogOut() {
		...
		System.out.println("Log out Alert Box = " + LogoutAlert);
		driver.switchTo().alert().accept();
	}
